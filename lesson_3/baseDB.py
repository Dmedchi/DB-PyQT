...
#     """создает таблицу 'ClientStory' и ее настраивает ее отображение"""
#     __tablename__ = 'ClientStory'
#     ClientStoryId = Column(Integer, primary_key=True)
#     ClientId = Column(Integer, ForeignKey('Client.ClientId'))
#     TimeEnter = Column(Date, nullable=False),
#     IP = Column(Integer, primary_key=True)          # ??
#
#     def __init__(self, client_id, address):
#         self.ClientId = client_id
#         self.IP = address
#         self.TimeEnter = time                    # time.ctime()- ???
